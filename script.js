...
$(document).ready(function(){
  ...
  console.log(state)
   ...
   total_active_UP=data.statewise[35].active
   total_confirmed_UP=data.statewise[35].confirmed
   total_recovered_UP=data.statewise[35].recovered
   total_deaths_UP=data.statewise[35].deaths
